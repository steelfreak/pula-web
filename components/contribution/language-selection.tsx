...
export function LanguageSelection({
  ...
  const filteredLanguages = languages.filter(
    (language: { lang_label: string; lang_code: string }) =>
  ...
  const getDisplayValue = () => {
    ...
    const selectedLanguage = languages.find(
      (lang: { lang_code: string; lang_label: string }) =>
    ...
    <div className="max-w-2xl mx-auto space-y-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Choose your primary language for word generation and target languages
          for contributions
        </p>
      </div>
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mb-3">
            This language will be used to source words and lexemes for
            contribution
          </p>
