...
export default function LanguageSelect({ value, onChange, placeholder = "Select language", label }: LanguageSelectProps) {
        ...
        >
          ...
          <div className="p-2 border-b" style={{ borderColor: "#e9ecef" }}>
            <div className="relative">
              <Search className="absolute left-2 top-1/2 transform -translate-y-1/2 w-4 h-4" style={{ color: "#72777d" }} />
              <input
                ref={searchInputRef}
                type="text"
          ...
          <div className="max-h-48 overflow-auto">
            ...
            {!loading && !error && filteredLanguages.map((language) => (
              <button
